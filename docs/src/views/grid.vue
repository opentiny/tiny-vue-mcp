        ...
        <tiny-form-item label="区域">
          <div class="cpu-config-container">
            ...
            <div class="cpu-select-item">
              ...
              <tiny-search v-model="state.specName" placeholder="输入关键词" class="spec-search"></tiny-search>
            </div>
          </div>
          <div class="spec-container">
            ...
            <div class="current-spec">
              ...
              <span class="spec-value">通用计算型 | s2.large.2 | 2vCPUs | 4 GiB</span>
            </div>
          </div>
        </tiny-form-item>
      </tiny-form>
    ...
    <div class="form-container">
      ...
      >
        <tiny-form-item label="系统盘">
          <div class="disk-config">
            ...
            ></tiny-base-select>
            <tiny-numeric v-model="state.systemDiskSize" placeholder="请输入" class="disk-input"></tiny-numeric>
      ...
      >
        <tiny-form-item label="数据盘">
          <div v-for="(disk, index) in state.dataDisks" :key="index" class="data-disk-item">
            ...
            ></tiny-base-select>
            <tiny-numeric v-model="disk.size" placeholder="请输入" class="disk-input"></tiny-numeric>
            <span class="disk-tip">GiB IOPS上限600，IOPS突发上限5,000</span>
            <tiny-numeric v-model="disk.iops" placeholder="请输入" class="disk-input"></tiny-numeric>
            <tiny-icon-delete v-if="index > 0" class="delete-icon" @click="removeDataDisk(index)"></tiny-icon-delete>
          </div>
          ...
          <tiny-col :span="12">
            <tiny-row>
              <tiny-col :span="5" class="purchase-col">
                ...
                <tiny-numeric v-model="state.purchaseCount" placeholder="请输入" class="purchase-input"></tiny-numeric>
                <span>台</span>
              </tiny-col>
              <tiny-col :span="7">
                <div>
